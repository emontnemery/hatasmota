...
NAMES = {
    ...
    SENSOR_STATUS_BATTERY: "Battery Level",
...
STATE_PATHS: dict[str, list[str | int]] = {
    ...
    SENSOR_STATUS_BATTERY: ["BatteryPercentage"],
...
QUANTITY = {
    ...
    SENSOR_STATUS_BATTERY: SENSOR_STATUS_BATTERY,
...
class TasmotaStatusSensorConfig(TasmotaBaseSensorConfig):
    ...
    def from_discovery_message(
        ...
        _LOGGER.warning("CONF_BATTERY <%d>", CONF_BATTERY)
        if CONF_BATTERY == 1:
