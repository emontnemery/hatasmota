...
# fmt: off
OPTION_MQTT_RESPONSE = "4"        # Return MQTT response as RESULT or %COMMAND%; added in Tasmota 9.0.0.4
...
OPTION_MQTT_SWITCHES = "114"      # Enable sending switch MQTT messages; added in Tasmota 9.0.0.4
# fmt: on
